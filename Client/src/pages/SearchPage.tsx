...
const SearchPage = () => {
    ...
    const toggleSongInPlaylist = async (playlist: PlaylistDetails) => {
        ...
        const isSongInPlaylist = playlist.songs.some(
            s => String(s.id) === String(selectedSong.id)
        );
                                    ...
                                    {results.songs.map((song: any) => (
                                        ...
                                        >
                                            ...
                                            <img
                                                src={
                                                    song.arrImage
                                                        ? `data:image/jpeg;base64,${song.arrImage}`
                                                        : '/default-cover.png'
                                                }
                                                alt={song.songName}
                                            />
                                ...
                                <div className="artists-grid-results">
                                    ...
                                    {results.artists.map((artist: any) => (
                                        ...
                                        >
                                            ...
                                            <img
                                                src={`data:image/jpeg;base64,${artist.arrImage}`}
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <img
                                                        src={
                                                            playlist.arrCover
                                                                ? `data:image/jpeg;base64,${playlist.arrCover}`
                                                    ...
                                                    <div
                                                        className={`custom-checkbox ${isAlreadyIn ? 'checked' : ''}`}
                                                    >
                                                        {isAlreadyIn && (
                                                            <Check size={14} />
                                                        )}
